...
@Component({
  ...
  styleUrls: ['./editcreditnote.component.css']
})
export class EditcreditnoteComponent implements OnInit {
  ...
  editPurchaseOrder() {
    ...
    api_req.moduleType = "creditNote";
    api_req.api_url = "creditNote/getCreditNoteedit";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    api_editPODetails.action = "creditNote/getCreditNoteedit";
    api_editPODetails.credit_note_id = this.edit_creditNoteID;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response != '') {
        ...
        this.addDo_section1.patchValue({          
          ...
          'e_vendor_name': response.data.credit_note_parent.customerCompany,
      ...
      //  this.vendor_Name = response.purchaseorderparent_details[0].vendorName;
        ...
        for (let index = 0; index < response.data.credit_note_child.length; index++) {
          ...
          formArray.push(this.fb.group({
            ...
            "pd_PurchaseOrderChildId": response.data.credit_note_child[index].credit_note_id,
  ...
  updatePurchaseOrder() {
    ...
    api_req.moduleType = "creditNote";
    api_req.api_url = "creditNote/getCreditNoteupdate";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    ...
    api_updatePO_req.user_id = localStorage.getItem('erp_c4c_user_id');
              ...
              //section 1
    api_updatePO_req.billerId = this.addDo_section1.value.companyName;
    api_updatePO_req.credit_note_no = this.addDo_section1.value.DocNo;
    api_updatePO_req.date = this.addDo_section1.value.DocDate
    api_updatePO_req.customer_id = this.customer_ID;
    api_updatePO_req.customerCompany = this.addDo_section1.value.companyNameDropdown;
    api_updatePO_req.b_address1 = this.addDo_section1.value.customerAddress1;
    api_updatePO_req.b_address2 = this.addDo_section1.value.customerAddress2;
    api_updatePO_req.b_address3 = this.addDo_section1.value.customerAddress3;
    api_updatePO_req.currency_id = this.addDo_section1.value.currency;
    api_updatePO_req.reference = this.addDo_section1.value.reference;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response.status == true) {
        ...
        iziToast.warning({
          message: "Credit Note Not Saved Successfully",
          position: 'topRight'
        });
        this.gotoPurchaseOrderList();
