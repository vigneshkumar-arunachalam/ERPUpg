...
@Component({
  selector: 'app-contributionmaster',
  templateUrl: './contributionmaster.component.html',
  styleUrls: ['./contributionmaster.component.css']
})
...
console.log("this.tempVariable",this.Purchase_Order);
  ...
  PurchaseOrderList(data: any) {
    ...
    api_req.moduleType = "hr";
    api_req.api_url = "hr/contributionMasterList"
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    api_deliveryOrder.action = "hr/contributionMasterList";
  ...
  goAddSalary() {
    this.router.navigate(['/addcontributionmaster'])
  }
  editSalaryEntry(id:any){
    this.router.navigate(['/editcontributionmaster'], {
      queryParams: {
        salaryId: id,
      }
    });
    ...
    this.rowSalaryID=id;
        Swal.fire({
          ...
          if (result.value) {
            ...
            let api_deliveryOrder: any = new Object();
            api_req.moduleType = "hr";
            api_req.api_url = "hr/deleteContributionDetails"
            api_req.api_type = "web";
            api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
            api_deliveryOrder.action = "hr/deleteContributionDetails";
            api_deliveryOrder.user_id = localStorage.getItem("erp_c4c_user_id");
