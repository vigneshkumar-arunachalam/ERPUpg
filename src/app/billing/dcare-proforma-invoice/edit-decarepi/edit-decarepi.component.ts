...
@Component({
  selector: 'app-edit-decarepi',
  templateUrl: './edit-decarepi.component.html',
  styleUrls: ['./edit-decarepi.component.css'],
})
export class EditDecarepiComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.section3_Terms2 =
      'Payment Term: 50% IN ADVANCE, 50% ON DELIVERY BY T/T';
    ...
    this.addPI_section3 = new FormGroup({
      ...
      section3_select_additional_signature: new FormControl(
  ...
  removeParticular(i: number) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        api_req.moduleType = 'dcare_proforma';
        api_req.api_url = 'dcare_proforma/delete_billing_child';
  ...
  EditCHK_MileDiscount(data: any, event: any) {
    ...
    if (this.checkbox_value_MileDiscount) {
      ...
      const index = this.edit_array_MileDiscount.findIndex(
        (el: any) => el === data
      );
      if (index > -1) {
  ...
  EditCHK_ExtraLogo(data: any, event: any) {
    ...
    if (this.checkbox_value_ExtraLogo) {
      ...
      const index = this.edit_array_ExtraLogo.findIndex(
        (el: any) => el === data
      );
      if (index > -1) {
  ...
  getProformaBillerDetails() {
    ...
    api_req.moduleType = 'dcare_proforma';
    api_req.api_url = 'dcare_proforma/get_proforma_biller_details';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response != '') {
        this.getProformaBillerDetails_tinName =
          response.biller_details[0].tinName;
        this.getProformaBillerDetails_tinNo = response.biller_details[0].tinNo;
        this.getProformaBillerDetails_cstName =
          response.biller_details[0].cstName;
  ...
  loadADD() {
    ...
    api_req.api_url = 'dcare_proforma/add_proforma_invoice';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
  ...
  TaxDropdown() {
    ...
    api_req.moduleType = 'dcare_proforma';
    api_req.api_url = 'dcare_proforma/tax_dropdown';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
  ...
  TaxDropdown_2() {
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      if (response.status == true) {
        ...
        this.tax_per_mod_2 = response.taxPer2;
  ...
  searchCustomer_selectDropdownData(data: any) {
    ...
    api_req.moduleType = 'dcare_proforma';
    api_req.api_url = 'dcare_proforma/customer_address_details';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
  ...
  getCustomerInvoiceDetails(event: any) {
    ...
    api_req.moduleType = 'dcare_proforma';
    api_req.api_url = 'dcare_proforma/get_customer_inv_details';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
  ...
  editPI() {
    ...
    api_req.moduleType = 'dcare_proforma';
    api_req.api_url = 'dcare_proforma/edit_proforma_invoice';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      if (response != '') {
        this.spinner.hide();
        this.exportState_value =
          response.billing_pararent_details[0].export_state;
        this.mileDiscountState_value =
          response.billing_pararent_details[0].mile_discount_state;
        // console.log(" this.mileDiscountState_value", this.mileDiscountState_value)
        this.billsLogo_value =
          response.billing_pararent_details[0].bills_logo_id;
        // this.getCustomerInvoiceDetails(response.billing_pararent_details[0].billerId);

        this.radio_Value_Export_logo =
          response.billing_pararent_details[0].bills_logo_id;
        this.radio_Value_ExportState =
          response.billing_pararent_details[0].export_state;
        this.radio_Value_InvoiceType =
          response.billing_pararent_details[0].mile_discount_state;
        this.ckeck_value_MileDisplay =
          response.billing_pararent_details[0].mile_discount_display_state;
        ...
        this.addPI_section1.patchValue({
          ...
          CurrencyConversionRate:
            response.billing_pararent_details[0].conversionRate,
          PaymentVia: response.billing_pararent_details[0].paymentVIA,
          e_export_state: response.billing_pararent_details[0].export_state,
          mile_discount_state:
            response.billing_pararent_details[0].mile_discount_state,
          ReferenceResellerName:
            response.billing_pararent_details[0].reference_reseller_name,
          ExtraLogo: response.billing_pararent_details[0].bills_logo_id,
          msDisplayFC:
            response.billing_pararent_details[0].mile_discount_display_state,
        });

        this.radio_Value_Mile =
          response.billing_pararent_details[0].mile_discount_state;
        this.addPI_section1.controls['e_export_state'].setValue(
          'response.billing_pararent_details[0].export_state'
        );
        this.TaxDropdown();
        this.TaxDropdown_2();
        ...
        for (
          let index = 0;
          index < response.billchild_details.length;
          index++
        ) {
          formArray.push(
            this.fb.group({
              ...
              pd_nextPage_checkbox:
                response.billchild_details[index].to_next_page == 1
                  ? true
                  : false,

              pd_productName_txtbox1:
                response.billchild_details[index].productName,
              pd_productName_txtArea:
                response.billchild_details[index].productDesc,
              ...
              pd_OutCall:
                response.billchild_details[index].out_call_state == 1
                  ? true
                  : false,
              ...
              pd_CMon:
                response.billchild_details[index].current_month == 1
                  ? true
                  : false,
              pd_selectTax:
                response.billchild_details[index].exc_tax_state == 1
                  ? true
                  : false,
            })
          );
        ...
        this.quotationAddSignature_filename =
          response.billing_pararent_details[0].signature_filename;

        if (response.billing_pararent_details[0].discountPer != '') {
          this.finalDiscountType = 'per';
          this.finalDiscountVal =
            response.billing_pararent_details[0].discountPer;
          ...
          this.finalDiscountVal =
            response.billing_pararent_details[0].discountAmount;
        }

        this.addPI_section3.patchValue({
          //row-1

          section3_gross_total:
            response.billing_pararent_details[0].grossAmount,
          //row-2
          //  'section3_discount_txtbox': this.finalDiscount,
          section3_discount_txtbox:
            response.billing_pararent_details[0].discountAmount,
          ...
          section3_gst_dropdown_2: response.billing_pararent_details[0].taxId2,
          section3_taxAmt_txtbox_2:
            response.billing_pararent_details[0].taxAmt2,
          section3_tax_per_hd_2: response.billing_pararent_details[0].taxPer2,
          //row-4
          section3_shipping_amt_name_txtbox:
            response.billing_pararent_details[0].shippingName,
          section3_shipping_amt_txtbox:
            response.billing_pararent_details[0].shippingAmt,
          ...
          //row-8
          section3_termCondition:
            response.billing_pararent_details[0].terms_condition_optional,
          ...
          //row-9
          section3_receivedAuthorizedSignature:
            response.billing_pararent_details[0].received_signature,

          //row-10
          section3_logo: response.billing_pararent_details[0].logo,
          // 'section3_logo': response.billing_pararent_details[0].print_logo,
          section3_select_additional_signature:
            response.quot_signature_show_state,
        });

        this.received_signature_state =
          response.billing_pararent_details[0].received_signature;
        ...
        this.getProformaBillerDetails();
        this.invoiceAddSignatureEdit(
          response.billing_pararent_details[0].signtureId
        );
        setTimeout(() => {
          // this.totalCalculate()
        }, 1500);
  ...
  updatePI() {
    ...
    api_req.moduleType = 'dcare_proforma';
    api_req.api_url = 'dcare_proforma/update_proforma_invoice';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
    ...
    api_updatePI_req.conversionRate =
      this.addPI_section1.value.CurrencyConversionRate;
    api_updatePI_req.paymentVIA = this.addPI_section1.value.PaymentVia;
    api_updatePI_req.reference_reseller_name =
      this.addPI_section1.value.ReferenceResellerName;
    ...
    api_updatePI_req.grossAmount =
      this.addPI_section3.value.section3_gross_total;
    //row-2

    api_updatePI_req.discountAmount =
      this.addPI_section3.value.section3_discount_txtbox;
    ...
    api_updatePI_req.taxId2 = this.addPI_section3.value.section3_gst_dropdown_2;
    api_updatePI_req.taxPer2 = this.tax_per_mod_2;
    api_updatePI_req.taxAmt2 =
      this.addPI_section3.value.section3_taxAmt_txtbox_2;
    //row-4
    api_updatePI_req.shippingName =
      this.addPI_section3.value.section3_shipping_amt_name_txtbox;
    api_updatePI_req.shippingAmt =
      this.addPI_section3.value.section3_shipping_amt_txtbox;
    ...
    //row-5
    api_updatePI_req.netPayment =
      this.addPI_section3.value.section3_grand_total;
    //row-6
    api_updatePI_req.remarks = this.addPI_section3.value.section3_remarks;
    //other row

    api_updatePI_req.terms_cond_chk =
      this.addPI_section3.value.section3_termCondition;
    ...
    api_updatePI_req.signatureId =
      this.addPI_section3.value.section3_select_additional_signature;
  ...
  getCurrencyValues(event: any) {
    ...
    let api_getInvoiceDetails_req: any = new Object();
    api_req.moduleType = 'dcare_proforma';
    api_req.api_url = 'dcare_proforma/get_currency_values';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
  ...
  keyPress(event: any, i: any) {
    ...
    if (this.finalTax2 > 0) {
      var tax = this.addPI_section3.value.section3_gst_dropdown_2;
      tax = ((parseFloat(tax) * parseFloat(this.grossTotal)) / 100).toFixed(2);
      if (this.grandTotal > 0) {
        this.grandTotal = this.grandTotal + parseFloat(tax);
      }
  ...
  saveDiscount() {
    ...
    if (disType == 'per') {
      ...
      if (enablePerFinal != '') {
        ...
        price = (
          (parseFloat(enablePerFinal) * parseFloat(final_tot)) /
          100
        ).toFixed(2);
  ...
  discount_dynamic_cal() {
    ...
    if (final_discount_type == 'per') {
      this.finalDiscount = (
        (parseFloat(this.grossTotal) * parseFloat(final_discount_val)) /
        100
      ).toFixed(2);
    }
    setTimeout(() => {
  ...
  getTaxCals2() {
    var tax_id = this.addPI_section3.value.section3_gst_dropdown_2;
    var tax: any;
    let api_req: any = new Object();
    let api_data_req: any = new Object();
    this.finalDiscount = $('#finalDiscount_amt').val();
    this.finalTax2 = $('#finalDiscount_amt').val();
    this.extraCharge = 0;
    api_req.moduleType = 'quotation';
    api_req.api_url = 'quotation/get_tax_percent_val';
    api_req.api_type = 'web';
  ...
  invoiceAddSignatureEdit(sign_val: any) {
    ...
    api_invoiceAddSignatureEdit_req.user_id =
      localStorage.getItem('erp_c4c_user_id');
    // api_quotationAddSignatureEdit_req.billerId = this.billerID ;
    api_invoiceAddSignatureEdit_req.billerId =
      this.addPI_section1.value.companyName;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response.status == true) {
        ...
        this.invoiceAddSignatureCHKShowState =
          response.invoice_signature_show_state;
