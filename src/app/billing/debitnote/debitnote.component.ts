...
export class DebitnoteComponent implements OnInit {
  ...
  addCreditNoteGo() {
    this.router.navigate(['/adddebitnote'])
  ...
  editCreditNoteGo(id: any, ) {
    ...
    this.router.navigate(['/editdebitnote'])
  ...
  getTransactionNewList(data: any) {
    ...
    api_req.api_url = "debitNote/getDebitNoteList";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    TNapi_req.action = "debitNote/getDebitNoteList";
