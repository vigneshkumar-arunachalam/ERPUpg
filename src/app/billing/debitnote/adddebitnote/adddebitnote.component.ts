...
@Component({
  selector: 'app-adddebitnote',
  templateUrl: './adddebitnote.component.html',
  styleUrls: ['./adddebitnote.component.css']
})
export class AdddebitnoteComponent implements OnInit {
  ...
  AddPurchaseOrder($event: MouseEvent) {
    ...
    api_req.api_url = "debitNote/getDebitNoteInsert";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    api_req_addPO.action = "debitNote/getDebitNoteInsert";
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response.status == 'true') {
        ...
        iziToast.error({
          message: "Debit Note not added Successfully",
          position: 'topRight'
        });
        this.gotoPurchaseOrderList();
      }
