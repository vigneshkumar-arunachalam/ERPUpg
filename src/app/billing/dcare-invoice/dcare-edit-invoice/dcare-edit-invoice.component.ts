...
@Component({
  selector: 'app-dcare-edit-invoice',
  templateUrl: './dcare-edit-invoice.component.html',
  styleUrls: ['./dcare-edit-invoice.component.css']
})
export class DcareEditInvoiceComponent implements OnInit {
  ...
  editInvoice() {
    ...
    api_req.api_url = "dcare_invoice/edit_invoice";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
     ...
     this.custAdr11=cus_address_break[0];
      ...
      //  console.log(this.addresses)
        ...
        this.addPI_section3.patchValue({
          ...
          'section3_taxAmt_txtbox_2': response.billing_pararent_details[0].taxAmt2,
  ...
  updateInvoice() {
   ...
   var vv = this.addPI_section1.value.shipTo_3;
    ...
    if (this.edit_Duplicate_ID == 'undefined' || this.edit_Duplicate_ID == undefined) {
      api_req.api_url = "dcare_invoice/update_invoice";
