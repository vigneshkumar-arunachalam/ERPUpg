...
@Component({
  selector: 'app-dcare-add-invoice',
  templateUrl: './dcare-add-invoice.component.html',
  styleUrls: ['./dcare-add-invoice.component.css']
})
export class DcareAddInvoiceComponent implements OnInit {
  ...
  removeAddress(i: number) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        api_req.api_url = "dcare_invoice/delete_billing_child";
  ...
  searchUserData(data: any) {
    ...
    let api_Search_req: any = new Object();
    api_req.moduleType = "dcare_invoice";
    api_req.api_url = "dcare_invoice/inv_reseller_name";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
  ...
  gotoInvoiceList() {
    ...
    this.router.navigate(['/dcare-invoice']);
  }
  save($event: MouseEvent) {
    ...
    api_req.moduleType = "dcare_invoice";
    api_req.api_url = "dcare_invoice/insert_invoice";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    ...
    api_saveInvoice_req.taxPer = selectedTax;
    api_saveInvoice_req.taxId2 = this.addPI_section3.value.section3_gst_dropdown_2;
    api_saveInvoice_req.taxAmt2 = this.addPI_section3.value.section3_taxAmt_txtbox_2;
    api_saveInvoice_req.taxPer2 = selectedTax2;
    /// tax end ///
  ...
  getCustomerInvoiceDetails() {
    ...
    api_req.moduleType = "dcare_invoice";
    api_req.api_url = "dcare_invoice/get_customer_inv_details";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
  ...
  getCurrencyValues(event: any) {
    ...
    let api_getInvoiceDetails_req: any = new Object();
    api_req.moduleType = "dcare_invoice";
    api_req.api_url = "dcare_invoice/get_currency_values";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
  ...
  totalCalculate() {
    ...
    for (let a = 0; a < list_cnt; a++) {
      ...
      if ($('#pd_selectTax_' + a).prop('checked') == true && this.tax_per_mod_2 != null) {
        this.net_amt = $('#pd_netPrice_' + a).val();

        tax_amt = (parseFloat(this.tax_per_mod_2) * parseFloat(this.net_amt) / 100);
    ...
    this.grandTotal = ((parseFloat(this.grossTotal) + parseFloat(this.finalTax) + parseFloat(this.finalTax2) + parseFloat(this.shipping_amt) + parseFloat(this.bankingCharge)) - parseFloat(this.finalDiscount)).toFixed(2);
  }
  ...
  invoiceAddSignature() {
    ...
    api_req.moduleType = "dcare_invoice";
    api_req.api_url = "dcare_invoice/invoice_add_signature";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
