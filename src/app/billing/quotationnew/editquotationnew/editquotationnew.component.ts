...
selectAdditionalSignUnchecked:boolean=false;
  ...
  editQuotation() {
    ...
    edit_Quotation_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationAddSignatureEdit(){
    ...
    api_quotationAddSignatureEdit_req.user_id = sessionStorage.getItem('user_id');
  ...
  updateQuotationEnquiry() {
    ...
    api_UpdateEnquiry_req.user_id = sessionStorage.getItem('user_id');
