...
export class QuotationnewComponent implements OnInit {
 ...
 values = '';
  ...
  search_BillerList() {
    ...
    api_SearchBiller_req.user_id = sessionStorage.getItem('user_id');
  ...
  addQuotationNew() {
    ...
    add_newQuotation_req.user_id = sessionStorage.getItem('user_id');
  ...
  editQuotationPopUP(QuotationId: any) {
    ...
    edit_popup_req.user_id = sessionStorage.getItem('user_id');
  ...
  duplicateQuotationPopUP(QuotationId: any) {
    ...
    duplicate_popup_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationSharedPersonEdit(QuotationId: any) {
    ...
    quot_share_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationSharedPersonUpdate() {
    ...
    quot_share_update_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationApprovalEdit(id: any) {
    ...
    quot_approval_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationApprovalUpdate() {
    ...
    quot_approvalUpdate_req.user_id = sessionStorage.getItem('user_id');
  ...
  deleteQuotation(id: any) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        delete_quotation_req.user_id = sessionStorage.getItem('user_id');
  ...
  setTemplateName(quotationId: any) {
    ...
    templateName_req.user_id = sessionStorage.getItem('user_id');
  ...
  templateNameUpdate() {
    ...
    templateNameUpdate_req.user_id = sessionStorage.getItem('user_id');
  ...
  setActualCost(quotationId: any) {
    ...
    actualCost_req.user_id = sessionStorage.getItem('user_id');
  ...
  setActualCostSave() {
    ...
    actualCostUpdate_req.user_id = sessionStorage.getItem('user_id');
  ...
  Email(QuotationID: any) {
    ...
    emailPage_req.user_id = sessionStorage.getItem('user_id');
  ...
  templateContentEmailDropdown(event: any) {
    ...
    api_quotationTemplateDropdown_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationCommentsEdit(quotationID: any, transactionID: any) {
    ...
    if (transactionID !=null) {
      ...
      transactionComment_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationCommentsSave() {
    ...
    transactionCommentSave_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationConvertPI() {
    ...
    api_quotConvertPI_req.user_id = sessionStorage.getItem('user_id');
  ...
  quotationExcelExport(quotationId:any){
    ...
    api_quotExcel_req.user_id = sessionStorage.getItem('user_id');
  ...
  DuplicateQuotationGo() {
    ...
    api_dup_req.user_id = sessionStorage.getItem('user_id');
