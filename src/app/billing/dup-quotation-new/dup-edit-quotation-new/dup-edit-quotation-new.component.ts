...
@Component({
  selector: 'app-dup-edit-quotation-new',
  templateUrl: './dup-edit-quotation-new.component.html',
  styleUrls: ['./dup-edit-quotation-new.component.css']
})
export class DupEditQuotationNewComponent implements OnInit {
