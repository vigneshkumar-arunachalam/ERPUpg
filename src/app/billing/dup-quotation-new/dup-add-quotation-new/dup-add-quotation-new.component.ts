...
@Component({
  selector: 'app-dup-add-quotation-new',
  templateUrl: './dup-add-quotation-new.component.html',
  styleUrls: ['./dup-add-quotation-new.component.css']
})
export class DupAddQuotationNewComponent implements OnInit {
