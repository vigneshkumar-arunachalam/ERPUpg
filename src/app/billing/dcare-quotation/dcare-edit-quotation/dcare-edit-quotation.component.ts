...
@Component({
  selector: 'app-dcare-edit-quotation',
  templateUrl: './dcare-edit-quotation.component.html',
  styleUrls: ['./dcare-edit-quotation.component.css'],
})
export class DcareEditQuotationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.addQuotationInvoice_section3 = new FormGroup({
      ...
      section3_gst_dropdown_2: new FormControl(null),
      section3_taxAmt_txtbox_2: new FormControl(null),
      section3_tax_per_hd_2: new FormControl(null),
  ...
  editAddress(): void {
    this.addresses = this.addQuotationInvoice_section2.get(
      'addresses'
    ) as FormArray;
  ...
  dynamicChange(event: any) {
    ...
    api_dynamicDropdown_req.user_id =
      this.editQuotationInvoice_section1.value.e_salesRep;
  ...
  editQuotation() {
    ...
    api_req.moduleType = 'dcare_quotation';
    api_req.api_url = 'dcare_quotation/edit_quotation';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response != '') {
        ...
        this.salesRepDropDown_Textbox_Status =
          response.sales_rep_status.dropdown_status;
        ...
        this.editQuotationInvoice_section1.patchValue({
          ...
          e_selectPDFTemplate:
            response.quotation_details[0].default_quotation_pdf_temp,

          e_selectTermsConditions:
            response.quotation_details[0].terms_condition_id,
          e_termsCondition_DontShow:
            response.quotation_details[0].terms_conditions_show_state,
          e_DescriptionText: response.quotation_details[0].description_details,
          e_descriptionDetails_DontShow:
            response.quotation_details[0].description_details_show_state,
          e_termConditionContentChange:
            response.quotation_details[0].terms_conditions,
          e_templateContent_Dropdown:
            response.quotation_details[0].main_content,
        });
        ...
        for (
          let index = 0;
          index < response.quotation_child_det.length;
          index++
        ) {
          this.sub_dis_type = '';
          this.sub_dis_val = '';
          ...
          formArray.push(
            this.fb.group({
              pd_productName_autocomplete:
                response.quotation_child_det[index].productName_desc,
              //  "pd_split": response.quotation_child_det[index].header_split,
              pd_productName_txtbox1:
                response.quotation_child_det[index].productName,
              pd_productName_txtArea:
                response.quotation_child_det[index].productDesc,
              pd_quantity_txtbox1: response.quotation_child_det[index].qty,
              pd_quotationChildId:
                response.quotation_child_det[index].quotationChildId,
              ...
              pd_split:
                response.quotation_child_det[index].header_split == 1
                  ? true
                  : false,
              pd_GPTotal:
                response.quotation_child_det[index]
                  .group_total_display_status == 1
                  ? true
                  : false,
              pd_selectTax:
                response.quotation_child_det[index].tax_state == 1
                  ? true
                  : false,
              to_next_page:
                response.quotation_child_det[index].to_next_page == 1
                  ? true
                  : false,
            })
          );
        ...
        this.quotationAddSignature_filename =
          response.quotation_details[0].signature_filename;
        ...
        this.addQuotationInvoice_section3.patchValue({
          ...
          //row-1
          section3_grant_total_show:
            response.quotation_details[0].total_display_status,
          ...
          section3_gst_dropdown_2: response.quotation_details[0].tax_id2,
          section3_taxAmt_txtbox_2: response.quotation_details[0].tax_amt2,
          section3_tax_per_hd_2: response.quotation_details[0].tax_per2,
          //row-4
          section3_shipping_amt_name_txtbox:
            response.quotation_details[0].shipping_amt_name,
          section3_shipping_amt_txtbox:
            response.quotation_details[0].shipping_amt,
          //row-5
          ...
          //row-7
          section3_signature_dropdown:
            response.quotation_details[0].additional_signature_id,
          //row-8
  ...
  templateContentDropdown(event: any) {
    ...
    api_quotationTemplateDropdown_req.user_id =
      localStorage.getItem('erp_c4c_user_id');
    api_quotationTemplateDropdown_req.quotation_template_id =
      this.quotation_template_id;
  ...
  quotationAddSignatureEdit(sign_val: any) {
    ...
    api_quotationAddSignatureEdit_req.user_id =
      this.editQuotationInvoice_section1.value.e_salesRep;
    // api_quotationAddSignatureEdit_req.billerId = this.billerID ;
    api_quotationAddSignatureEdit_req.billerId =
      this.editQuotationInvoice_section1.value.e_companyName;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response.status == true) {
        ...
        this.quotationAddSignatureCHKShowState =
          response.quot_signature_show_state;
  ...
  TermsConditionsContentDropdown(event: any) {
    ...
    api_quotationTemplateDropdown_req.user_id =
      localStorage.getItem('erp_c4c_user_id');
    api_quotationTemplateDropdown_req.terms_condition_id =
      this.terms_condition_id;
    api_req.element_data = api_quotationTemplateDropdown_req;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response.status == true) {
        ...
        // alert(response.terms_condition_details)
        this.editQuotationInvoice_section1.patchValue({
  ...
  TaxDropdown() {
    ...
    api_req.moduleType = 'dcare_quotation';
    api_req.api_url = 'dcare_quotation/quot_tax_dropdown';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
    ...
    api_TaxDropdown_req.billId = this.editQuotationID;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response.status == true) {
        ...
        this.tax_per_mod = response.tax_per1;
      }
    });
  ...
  TaxDropdown_2() {
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response.status == true) {
        this.TaxDropdownList_2 = response.tax_list;
        this.tax_per_mod_2 = response.tax_per2;
      }
    });
  }
  currencyQuotationTermChange() {
    ...
    api_currencyQuotationTermChange.terms_conditions =
      this.dynamicTermsConditions_Currency;
  ...
  updateQuotationEnquiry($event: MouseEvent) {
    ...
    api_req.moduleType = 'dcare_quotation';
    api_req.api_url = 'dcare_quotation/update_quotation';
    api_req.api_type = 'web';
    api_req.access_token =
      'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI';
    api_UpdateEnquiry_req.action = 'update_quotation';
    api_UpdateEnquiry_req.user_id = localStorage.getItem('erp_c4c_user_id');
    ...
    api_UpdateEnquiry_req.quotation_valid_day =
      this.validity_enquiryFromDetails;
    ...
    api_UpdateEnquiry_req.billerId =
      this.editQuotationInvoice_section1.value.e_companyName;
    api_UpdateEnquiry_req.quotation_no =
      this.editQuotationInvoice_section1.value.e_quotationNumber;
    api_UpdateEnquiry_req.pdf_footer_id =
      this.editQuotationInvoice_section1.value.e_selectFooter;
    // api_UpdateEnquiry_req.pdf_footer_id = $('input:radio[name=selectFooter_name]:checked').val();
    api_UpdateEnquiry_req.quotation_date =
      this.editQuotationInvoice_section1.value.e_quotationDate;
    api_UpdateEnquiry_req.customer_id =
      this.editQuotationInvoice_section1.value.e_customer_id;
    api_UpdateEnquiry_req.customerName =
      this.editQuotationInvoice_section1.value.e_customerName;

    // api_UpdateEnquiry_req.customer_id = this.editQuotationInvoice_section1.value.customer_id;
    api_UpdateEnquiry_req.customerAddress1 =
      this.editQuotationInvoice_section1.value.e_cust_address1;
    api_UpdateEnquiry_req.customerAddress2 =
      this.editQuotationInvoice_section1.value.e_cust_address2;
    api_UpdateEnquiry_req.customerAddress3 =
      this.editQuotationInvoice_section1.value.e_cust_address3;
    api_UpdateEnquiry_req.kind_Attention =
      this.editQuotationInvoice_section1.value.e_attention;
    api_UpdateEnquiry_req.billGeneratedBy =
      this.editQuotationInvoice_section1.value.e_salesRep;
    api_UpdateEnquiry_req.quotation_template_id =
      this.editQuotationInvoice_section1.value.e_selectTemplate;
    api_UpdateEnquiry_req.reseller_id =
      this.editQuotationInvoice_section1.value.e_selectReseller;
    api_UpdateEnquiry_req.main_content =
      this.editQuotationInvoice_section1.value.e_templateContent_Dropdown;
    api_UpdateEnquiry_req.currencyId =
      this.editQuotationInvoice_section1.value.e_selectCurrency;
    api_UpdateEnquiry_req.bills_logo_id =
      this.editQuotationInvoice_section1.value.e_extraLogo;
    api_UpdateEnquiry_req.default_quotation_pdf_temp =
      this.editQuotationInvoice_section1.value.e_selectPDFTemplate;
    api_UpdateEnquiry_req.terms_condition_id =
      this.editQuotationInvoice_section1.value.e_selectTermsConditions;
    api_UpdateEnquiry_req.terms_conditions_show_state =
      this.checkbox_termsCondition_DontShow;
    api_UpdateEnquiry_req.terms_conditions =
      this.editQuotationInvoice_section1.value.e_termConditionContentChange;
    api_UpdateEnquiry_req.description_details =
      this.editQuotationInvoice_section1.value.e_DescriptionText;
    api_UpdateEnquiry_req.description_details_show_state =
      this.checkbox_descriptionDetails_DontShow;
    ...
    for (let i = 0; i < addr.length; i++) {
      const addressesArray = this.addQuotationInvoice_section2.get(
        'addresses'
      ) as FormArray;
      ...
      addr[i].pd_productName_autocomplete = addressesArray
        .at(i)
        .get('pd_productName_autocomplete')?.value;
    ...
    //row-1
    api_UpdateEnquiry_req.total_display_status =
      this.addQuotationInvoice_section3.value.section3_grant_total_show;
    api_UpdateEnquiry_req.gross_total =
      this.addQuotationInvoice_section3.value.section3_gross_total;
    //row-2
    api_UpdateEnquiry_req.discount_amt_tot =
      this.addQuotationInvoice_section3.value.section3_discount_txtbox;
    api_UpdateEnquiry_req.final_dis_type =
      this.addQuotationInvoice_section3.value.final_dis_type;
    api_UpdateEnquiry_req.final_dis_val =
      this.addQuotationInvoice_section3.value.final_dis_val;
    //row-3
    ...
    api_UpdateEnquiry_req.taxId =
      this.addQuotationInvoice_section3.value.section3_gst_dropdown;
    api_UpdateEnquiry_req.taxPer = this.tax_per_mod;
    api_UpdateEnquiry_req.taxAmt =
      this.addQuotationInvoice_section3.value.section3_taxAmt_txtbox;
    api_UpdateEnquiry_req.taxId2 =
      this.addQuotationInvoice_section3.value.section3_gst_dropdown_2;
    api_UpdateEnquiry_req.taxPer2 = this.tax_per_mod_2;
    api_UpdateEnquiry_req.taxAmt2 =
      this.addQuotationInvoice_section3.value.section3_taxAmt_txtbox_2;

    //row-4
    api_UpdateEnquiry_req.shipping_amt_name =
      this.addQuotationInvoice_section3.value.section3_shipping_amt_name_txtbox;
    api_UpdateEnquiry_req.shipping_amt =
      this.addQuotationInvoice_section3.value.section3_shipping_amt_txtbox;
    //row-5
    api_UpdateEnquiry_req.grand_total =
      this.addQuotationInvoice_section3.value.section3_grand_total;
    //row-6
    api_UpdateEnquiry_req.remarks =
      this.addQuotationInvoice_section3.value.section3_remarks;
    //row-7
    api_UpdateEnquiry_req.additional_signature_id =
      this.addQuotationInvoice_section3.value.section3_signature_dropdown;
    //row-8
    api_UpdateEnquiry_req.template_name =
      this.addQuotationInvoice_section3.value.section3_templateName;

    //row-9
    api_UpdateEnquiry_req.quot_signature_show_state =
      this.checkbox_selectAdditionalSignature;
  ...
  totalCalculate() {
    ...
    for (let a = 0; a < list_cnt; a++) {
      ...
      if (discount_type == 'per') {
        ...
        dis_amt_val = (
          (parseFloat(this.sub_dis_val) * parseFloat(total_amt)) /
          100
        ).toFixed(2);
      ...
      if (
        $('#pd_selectTax_' + a).prop('checked') == true &&
        this.tax_per_mod != null
      ) {
        this.net_amt = $('#pd_netPrice_' + a).val();

        tax_amt =
          (parseFloat(this.tax_per_mod) * parseFloat(this.net_amt)) / 100;
        tax_amt_tot += tax_amt;
      }
      if (
        $('#pd_selectTax_' + a).prop('checked') == true &&
        this.tax_per_mod_2 != null
      ) {
        this.net_amt = $('#pd_netPrice_' + a).val();

        tax_amt =
          (parseFloat(this.tax_per_mod_2) * parseFloat(this.net_amt)) / 100;
        tax_amt_tot2 += tax_amt;
      }
    ...
    this.grossTotalTax_2 = tax_amt_tot2;

    if (tax_amt_tot > 0) {
      tax_amt_tot =
        (parseFloat(this.tax_per_mod) *
          (parseFloat(this.grossTotalTax) - parseFloat(this.finalDiscount))) /
        100;
    }

    if (tax_amt_tot2 > 0) {
      tax_amt_tot2 =
        (parseFloat(this.tax_per_mod_2) *
          (parseFloat(this.grossTotalTax_2) - parseFloat(this.finalDiscount))) /
        100;
    }

    this.finalTax = tax_amt_tot.toFixed(2);
    this.finalTax2 = tax_amt_tot2.toFixed(2);
    ...
    this.grandTotal = (
      ...
      parseFloat(this.finalTax) +
      parseFloat(this.finalTax2) +
      parseFloat(this.shipping_amt) -
      parseFloat(this.finalDiscount)
    ).toFixed(2);
  }
  ...
  getTaxCals_2() {
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      this.tax_per_mod_2 = response.percent_val;
      $('#tax_per_hd_id_2').val(response.percent_val);

      tax = response.percent_val;
      tax = ((parseFloat(tax) * parseFloat(this.grossTotal)) / 100).toFixed(2);

      this.finalTax2 = parseFloat(tax);
      // if (this.grossTotal > 0) {
      //   this.grandTotal = (this.grossTotal + this.finalTax + this.finalDiscount + this.extraCharge).toFixed(2);
      // }
      this.finalTax2 = parseFloat(tax).toFixed(2);
    });
  ...
  // }
  redirecttoQuotation() {
    this.router.navigate(['/dcare-quotation']);
  }
