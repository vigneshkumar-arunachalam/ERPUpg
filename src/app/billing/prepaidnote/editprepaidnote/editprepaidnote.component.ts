...
@Component({
  selector: 'app-editprepaidnote',
  templateUrl: './editprepaidnote.component.html',
  styleUrls: ['./editprepaidnote.component.css']
})
export class EditprepaidnoteComponent implements OnInit {
  ...
  removeAddress(i: number) {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        api_req.api_url = "prepaidNote/delete_prepaidnote_child";
        api_req.api_type = "web";
        api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
        api_ProdAutoFill_req.action = "prepaidNote/delete_prepaidnote_child";
  ...
  editPurchaseOrder() {
    ...
    api_req.moduleType = "prepaidNote";
    api_req.api_url = "prepaidNote/getprepaidtNoteedit";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    api_editPODetails.action = "prepaidNote/getprepaidtNoteedit";
    api_editPODetails.prepaid_id = this.edit_creditNoteID;
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response != '') {
        ...
        this.defBiller_ID = response.data.prepaid_parent.billerId;

        this.addDo_section1.patchValue({
          'e_companyName': response.data.prepaid_parent.billerId,
          'e_DocNo': response.data.prepaid_parent.prepaid_no,
          'e_DocDate': response.data.prepaid_parent.prepaid_date,
          'e_companyNameDropdown': response.data.prepaid_parent.kind_Attention,


          'e_customerAddress1': response.data.prepaid_parent.b_address1,
          'e_customerAddress2': response.data.prepaid_parent.b_address2,
          'e_customerAddress3': response.data.prepaid_parent.b_address3,
          'e_currency': response.data.prepaid_parent.currency_id,
        ...
        this.prepaid_id = response.data.prepaid_parent.prepaid_id;
        this.addPI_section3.patchValue({
          'poId': response.data.prepaid_parent.customerName,
          'section3_gross_total': response.data.prepaid_parent.total_amt,
          'section3_gst_dropdown': response.data.prepaid_parent.taxId,
          'section3_tax_per_hd': response.data.prepaid_parent.taxPer,
          'section3_taxAmt_txtbox': response.data.prepaid_parent.taxAmt,
          'section3_grand_total': response.data.prepaid_parent.net_total_amt,
        });
        //  this.vendor_Name = response.purchaseorderparent_details[0].vendorName;

        const formArray = new FormArray([]);
        for (let index = 0; index < response.data.prepaid_child.length; index++) {
          ...
          formArray.push(this.fb.group({
            ...
            "pd_PurchaseOrderChildId": response.data.prepaid_child[index].prepaid_child_id,
            "prodName": response.data.prepaid_child[index].description,
            "quantity": response.data.prepaid_child[index].qty,
            "desc": response.data.prepaid_child[index].description,
            "price": response.data.prepaid_child[index].price,
            "total": response.data.prepaid_child[index].total_price,
        ...
        console.log(this.addresses)
        this.editAddress();
        this.removeAddresstest(response.data.prepaid_child.length);
  ...
  updatePurchaseOrder() {
    ...
    api_req.moduleType = "prepaidNote";
    api_req.api_url = "prepaidNote/getprepaidNoteupdate";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    api_updatePO_req.action = "prepaidNote/getprepaidNoteupdate";
    ...
    api_updatePO_req.prepaid_id = this.prepaid_id;
    api_updatePO_req.prepaid_no = this.addDo_section1.value.e_DocNo;
    ...
    for (let i = 0; i < addr.length; i++) {
      ...
      addr[i].prepaid_id = this.edit_creditNoteID;
      addr[i].prepaid_child_id = $('#pd_purchaseOrderChildId_' + i).val();
    }
    ...
    this.serverService.sendServer(api_req).subscribe((response: any) => {
      ...
      if (response.status == true) {
        ...
        iziToast.success({
          title: 'Updated',
          message: 'Prepaid Note Updated Successfully !',
        });
        ...
        iziToast.warning({
          message: "Prepaid Note Not Updated",
          position: 'topRight'
        });
        this.gotoPurchaseOrderList();
