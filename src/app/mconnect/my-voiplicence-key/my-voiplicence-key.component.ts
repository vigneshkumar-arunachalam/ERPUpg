...
export class MyVOIPLicenceKeyComponent implements OnInit {
  ...
  calculatePeriod() {
    const from = new Date(this.setKeyPeriodForm.get('fromDate')?.value);
    const to = new Date(this.setKeyPeriodForm.get('toSetDate')?.value);
