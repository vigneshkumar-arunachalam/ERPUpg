...
@Component({
  selector: 'app-add-rate-catalog',
  templateUrl: './add-rate-catalog.component.html',
  styleUrls: ['./add-rate-catalog.component.css']
})
export class AddRateCatalogComponent implements OnInit {
