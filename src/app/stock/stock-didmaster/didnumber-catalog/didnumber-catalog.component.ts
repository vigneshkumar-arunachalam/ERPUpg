...
@Component({
  selector: 'app-didnumber-catalog',
  templateUrl: './didnumber-catalog.component.html',
  styleUrls: ['./didnumber-catalog.component.css']
})
export class DIDNumberCatalogComponent implements OnInit {
  ...
  didNumberCatalogList(data: any) {
    ...
    api_req.api_url = "didcatelog_stock/did_catelog_list";
    api_req.api_type = "web";
    api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
    api_postUPd.action = "didcatelog_stock/did_catelog_list";
  ...
  delete(did_number_catalog_id: any) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          ...
          api_req.moduleType = "didcatelog_stock";
          api_req.api_url = "didcatelog_stock/delete";
          api_req.api_type = "web";
          api_req.access_token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..NaymQDSiON2R3tKICGNpj6hsQfg9DGwEcZzrJcvsqbI";
          api_singleDelete.action = "didcatelog_stock/delete";
          api_singleDelete.user_id = localStorage.getItem('erp_c4c_user_id');

          api_singleDelete.did_number_catalog_id = did_number_catalog_id;
