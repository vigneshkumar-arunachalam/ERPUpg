...
export class ContractclassificationComponent implements OnInit {
  ...
  updateContractClassification() {
    ...
    if (this.editContractClassificationForm.value.e_cont_classification_name == '' ||
      this.editContractClassificationForm.value.e_cont_classification_name == undefined ||
      this.editContractClassificationForm.value.e_cont_classification_name == 'undefined') {
      iziToast.error({
        message: "Update Name",
        position: 'topRight'
    ...
    if (this.editContractClassificationForm.value.e_description_name == '' ||
      this.editContractClassificationForm.value.e_description_name == undefined ||
      this.editContractClassificationForm.value.e_description_name == 'undefined') {
      iziToast.error({
    ...
    if (this.editContractClassificationForm.value.e_color_name == '' ||
      this.editContractClassificationForm.value.e_color_name == undefined ||
      this.editContractClassificationForm.value.e_color_name == 'undefined') {
      iziToast.error({
