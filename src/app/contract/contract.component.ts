...
export class ContractComponent implements OnInit {
  ...
  contractDeleteGroup() {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        GrpDelete_contract_req.user_id = "2";
  ...
  contractAttachmentDelete(id: any) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        delete_contractAttach_req.user_id = "2";
  ...
  customerContractApproveStatus(customerContractId: any) {
    ...
    api_ApproveStatus_req.user_id = "2";
